...
probably should output into like a json to save it and make it portable

which means we should probably unpack it to into like excel or something, but maybe csv output is good enough too
